...
if [[ "$MODE" == "full" ]]; then
  ...
  # prometheus stack
  pull_tag "grafana/grafana:13.1.1" "brinnatt/grafana:13.1.1"
  pull_tag "busybox:1.37" "brinnatt/busybox:1.37"
  pull_tag "quay.io/kiwigrid/k8s-sidecar:1.30.5" "brinnatt/k8s-sidecar:1.30.5"
  pull_tag "quay.io/prometheus/prometheus:v3.13.1-distroless" "brinnatt/prometheus:v3.13.1-distroless"
  pull_tag "quay.io/prometheus/alertmanager:v0.33.1" "brinnatt/alertmanager:v0.33.1"
  pull_tag "quay.io/prometheus/node-exporter:v1.12.1" "brinnatt/node-exporter:v1.12.1"
  pull_tag "quay.io/prometheus-operator/prometheus-operator:v0.93.0" "brinnatt/prometheus-operator:v0.93.0"
  pull_tag "quay.io/prometheus-operator/prometheus-config-reloader:v0.93.0" "brinnatt/prometheus-config-reloader:v0.93.0"
  pull_tag "quay.io/prometheus-operator/admission-webhook:v0.93.0" "brinnatt/prometheus-admission-webhook:v0.93.0"
  pull_tag "ghcr.io/jkroepke/kube-webhook-certgen:1.8.5" "brinnatt/prometheus-webhook-certgen:1.8.5"
  pull_tag "registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.18.0" "brinnatt/kube-state-metrics:v2.18.0"
